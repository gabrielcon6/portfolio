...
$(document).ready(function () {
  console.log(
    `%c Hi there! ${wave} Thanks for checking the console. I hope you have a nice reading! :D`,
    styles
  );
  $(".cross").hide();
  $(".menu").hide();
  ...
  $(".down-projects").click(function () {
    console.log(
      `%c If you wanna play Smash Brothers with me, just hmu! ${videogame}`,
      styles
    );
  });
  ...
  $(".down-contact").click(function () {
    console.log(
      `%c Thanks for checking my projects! My contact details are below ${happy}`,
      styles
    );
  });
